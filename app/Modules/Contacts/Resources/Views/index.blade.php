                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="javascript:void (0);" onclick="location.reload();">Reload
                                    this contact</a>
                                @if(Creeper::canOrabort('delete-contacts'))
...
@section('modals')
    @if(Creeper::canOrabort('delete-contacts'))
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="delete_form" action="{{route('contacts.index')}}" method="post">
                            {{csrf_field()}}
        ...
        <!-- !Delete form -->
    @endif
    @if(Creeper::canOrabort('read-contacts'))
        <!-- View profile -->
...
@push('style')
    ...
    <style>
        ...
        @endif
        @if(!Creeper::canOrabort('update-contacts'))
            .edit {
            display: none;
        }
...
@push('scripts')
    ...
    <script type="text/javascript">
        var table = $('.table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{route('contacts.serverside.getData')}}",
            "columns": [
        ...
        function deleteSelected() {
            ...
            if (data.length === 0) {
                ...
                $('.preloader').show();
                axios.get('{{route('contacts.deleteSelected')}}', {
                    params: {
                        data: data
                    }
                })

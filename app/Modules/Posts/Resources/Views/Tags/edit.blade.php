        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material row" action="{{route('blog.tags.update', $item->id)}}"
                          method="post">
                        {{csrf_field()}}
                                    ...
                                    <div class="tab-pane active" id="settings" role="tabpanel">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <select class="form-control" id="status" name="status">
                                                        <option value="draft"
                                                                @if($item->status == 'draft') selected @endif>Draft
                                                        </option>
                                                        <option value="pending"
                                                                @if($item->status == 'pending') selected @endif>Pending
                                                        </option>
                                                        <option value="publish"
                                                                @if($item->status == 'publish') selected @endif>Publish
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="pos" class="form-control form-control-line"
                                                           value="{{$item->pos}}" id="name">
                                                </div>
                                            </div>

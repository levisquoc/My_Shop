...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Create new role <a class="btn btn-danger btn-circle pull-right"
                                                              data-toggle="tooltip" title="Back"
                                                              href="{{route('acl.roles.index')}}"><i
                                    class="fa fa-times"></i></a></h4>

                    <div class="p-20">
                        <form class="form-material" action="{{route('acl.roles.store')}}" method="post">
                            {{csrf_field()}}

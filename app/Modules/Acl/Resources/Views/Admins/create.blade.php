...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Create new admins <a class="btn btn-danger btn-circle pull-right"
                                                                data-toggle="tooltip" title="Back"
                                                                href="{{route('acl.admins.index')}}"><i
                                    class="fa fa-times"></i></a></h4>

                    <form class="form-horizontal form-material row" action="{{route('acl.admins.store')}}"
                          method="post">
                        {{csrf_field()}}
                        ...
                        <div class="col-lg-4 col-xlg-3 col-md-5">
                            <div class="card">
                                <div class="card-body">
                                    <center class="m-t-30">
                                        <img src="Modules/Acl/images/useravatar.svg" id="holder" class="img-circle w-50"
                                             style="height: 150px"/>
                                    ...
                                    <div class="tab-pane active" id="settings" role="tabpanel">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="name" placeholder="johnathandoe"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small class="col-md-12 form-text text-muted">Secret password necessary
                                                    for get new password when forgot your password.
                                                </small>
                                                <div class="col-md-12">

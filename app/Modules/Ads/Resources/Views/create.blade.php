...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Create new Ads <a class="btn btn-danger btn-circle pull-right"
                                                             data-toggle="tooltip" title="Back"
                                                             href="{{route('ads.index')}}"><i
                                    class="fa fa-times"></i></a></h4>

                    <form class="form-horizontal form-material row" action="{{route('ads.store')}}" method="post"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="settings" role="tabpanel">
                                        <div class="card-body">
                                            ...
                                            <input type="hidden" id="thumbnail" name="image" value="{{old('image')}}">
                                            <!-- Column -->
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <img id="holder" class="mt-2 img-thumbnail" src="{{old('image')}}"/>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <div id="categories" class="form-group hidden">
                                                <label for='position' class='col-md-12'>Categories</label>
                                                <div class='col-md-12'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input class="form-control datetimepicker" name="publish_date"
                                                           value="{{old('publish_date')}}" id="publish_date">
                                                </div>
                                            </div>
                                            <div class="form-group">
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(window).on('load', function () {
            var cate = $("#position option:selected").val();
            var odd = '{{old('position')}}';
            if (cate == 'Banner' || odd == 'Banner') {
                $('#categories').removeClass('hidden');
//                    $('#categories').append("<label for='position' class='col-md-12'>Position</label><div class='col-md-12'><select class='form-control' name='cate'>@foreach($categories as $category)<option value='{{$category->slug}}'>{{$category->name}}</option>@endforeach</select></div>");
//                } else {
//                    $('#categories').empty();
//                }
            }

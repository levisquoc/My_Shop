            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="icons">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="javascript:void (0);" onclick="location.reload();">Reload
                                    this page</a>
                                @if(Creeper::canOrabort('delete-ads'))
                        ...
                        @if(Creeper::canOrabort('create-ads'))
                            <a href="{{route('ads.create')}}" class="btn btn-outline-success btn-rounded"><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="delete_form" action="{{route('ads.index')}}" method="post">
                            {{csrf_field()}}
...
@push('style')
    ...
    <style>
        ...
        @endif
        @if(!Creeper::canOrabort('update-ads'))
            .edit {
            display: none;
        }
        @endif
...
@push('scripts')
    ...
    <script type="text/javascript">
        var table = $('.table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{route('ads.serverside.getads')}}",
            "columns": [
        ...
        function deleteSelected() {
            ...
            if (data.length === 0) {
                swal({
                    title: "Oops...",
                    text: "Please select ads for use this action",
                    type: "error"
                });
            }
            else {
                $('.preloader').show();
                axios.get('{{route('ads.deleteSelected')}}', {
                    params: {
                        data: data
                    }
                })

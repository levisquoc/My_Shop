...
>
{
    ...
    then(() = > {
        expect(document.querySelector('.tooltip')
).
    not.toBeNull();
    done();
})
    ...
    then(() = > {
        expect(document.querySelector('.tooltip').style.display
).
    toBe('none');
    done();
})
...
then(() = > {
    expect(document.querySelector('.tooltip').parentNode
).
toBe(
    document.body
);
...
then(() = > {
    expect(document.querySelector('.tooltip .tooltip-inner').textContent
).
toBe('foobar');
done();
})
...
then(() = > {
    expect(document.querySelector('.tooltip .tooltip-inner').innerHTML
).
...
then(() = > {
    expect(document.querySelector('.tooltip .foobar').textContent
).
toBe(
    'foobar'
);

                                                        ...
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    <p id="menu-item-url-wrap">
                                                                        <label class="howto" for="custom-menu-item-url"> <span>			<button
                                                                                        type="button" id="myModal"
														  ...
														  <i class="fa fa-link" aria-hidden="true"></i>
                                                                            ...
                                                                            <input style="margin-top: 10px;"
                                                                                   id="custom-menu-item-url" name="url"
                                                                                   type="text"
                                                                                   class="code menu-item-textbox item-link">
                                                                        </label>
                                                                    </p>
                                                                        ...
                                                                        <div class="menu-item-settings"
                                                                            ...
                                                                            <p class="field-css-url description description-wide">
                                                                                <label for="edit-menu-item-url-{{$m->id}}">
                                                                                    <button type="button"
                                                                                            id="myModalEdit"
                                                                                            class="btn btn-primary pull-left myModalEdit"
                                                                                            data-id="{{ $m->id }}"
                                                                                            data-toggle="modal"
                                                                                            data-target="#exampleModal">
                                                                                        <i class="fa fa-link"
                                                                                    ...
                                                                                    <input type="text"
                                                                                           id="url_menu_{{$m->id}}"
                                                                                           class="widefat code edit-menu-item-url item-link-edit"
                                                                                           id="url_menu_{{$m->id}}"
                                                                                           value="{{$m->link}}">
                                                                                </label>
                                                                            </p>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $('.myModalEdit').click(function () {
            ...
            $('#save-item-edit').attr('data-target', 'url_menu_' + item_id);
